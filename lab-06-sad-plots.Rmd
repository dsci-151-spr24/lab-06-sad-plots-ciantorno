...
***I would make the other lines of this plot gray to accentuate the part-time faculty line's growth.  This way, it will be clearer to see that this proportion went up over time while the others stayed relatively the same.***
...
***First of all, I would get rid of the pie charts, since they are hard to read.  Secondly, I would figure out a way to visualize the data so that it is easier to read.  Third of all, I would label the x and y axis and add a legend so that it is easier to see what story the chart is trying to tell.***
...
fisheries %>%
  ...
  pivot_longer(cols = -country, names_to = "type") %>%
    ...
    labs(title = "Fishing by Country", subtitle = "Out of 26 Countries") +
    xlab("Proportion") +
    ylab("")
